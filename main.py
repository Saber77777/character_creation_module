...
def attack(char_name: str, char_class: str) -> str:
    """Генерирует количество очков атаки в зависимости от выбранного персонажа.
...
def defence(char_name: str, char_class: str) -> str:
    """Генерирует количество очков защиты в зависимости от выбранного персонажа.
    и возвращает строковое сообщение о выполненном блокировании атаки.
    """
    if char_class == 'warrior':
